...
public class StudentServiceImpl implements IStudentService {
    ...
    public Student verifyStudent(String studentIdentifier, String password) {
        Student student = this.studentDao.selectStudentByStudentIdentifierAndPassword(studentIdentifier, password);
        System.out.println("数据库的学生姓名为");
        System.out.println(student.getStudentIdentifier());
